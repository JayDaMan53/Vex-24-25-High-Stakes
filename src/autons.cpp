...
pros::Motor aLb (2, pros::E_MOTOR_GEARSET_18, false);
...
void HighStakesSkills() {
  ...
  chassis.wait_drive();
  chassis.set_drive_pid(-110, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  apiston.set_value(1);
  apiston2.set_value(1);
  ...
  chassis.set_turn_pid(90, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(60, DRIVE_SPEED, false, false);
  chassis.wait_drive();
  chassis.reset_gyro();
...
void redGoalside() { // mogo side
  ...
  chassis.wait_drive();
  pros::delay(500);
  chassis.set_turn_pid(180 + 55, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(-60, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  pros::delay(250);
  apiston.set_value(1);
  pros::delay(500);
  chassis.set_turn_pid(90 + 65, TURN_SPEED);
  chassis.wait_drive();
  aintakeB.move(-127);
  chassis.set_drive_pid(60, DRIVE_SPEED, false, true);
  chassis.wait_drive();
...
void blueGoalside() { // mogo side
  ...
  chassis.set_drive_pid(-55, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  chassis.set_turn_pid(55 + 180, TURN_SPEED);
  chassis.wait_drive();
  aintakeA.move(127);
  chassis.set_drive_pid(20, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  pros::delay(500);
  chassis.set_turn_pid(180 + 55 + 180, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(-60, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  pros::delay(250);
  ...
  pros::delay(500);
  aintakeB.move(-127);
  chassis.set_turn_pid(90 + 65 + 180, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(60, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  extern int arank;
...
void blueRingside() { // ring side
  ...
  aintakeB.move(-127);
  aintakeA.move(127);
  chassis.set_turn_pid(-100 + 180, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(50, DRIVE_SPEED , false, true);
  chassis.wait_drive();
  chassis.set_drive_pid(-50, DRIVE_SPEED , false, true);
  chassis.wait_drive();
  chassis.set_turn_pid(-90 + 180, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(70, DRIVE_SPEED , false, true);
  chassis.wait_drive();
  chassis.set_drive_pid(-50, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  chassis.set_turn_pid(-60 + 180, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(45, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  chassis.set_drive_pid(-45, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  chassis.set_turn_pid(180-45 + 180, TURN_SPEED);
  chassis.wait_drive();
}
...
void skillsflip() { // mid ahh skills
  ...
  chassis.set_turn_pid(90, TURN_SPEED);
  chassis.wait_drive();
  chassis.set_drive_pid(-165, DRIVE_SPEED, false, true);
  chassis.wait_drive();
  pros::delay(250);
  apiston.set_value(1);
  pros::delay(250);
